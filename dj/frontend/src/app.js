        ...
        <div className='app-container'>
            ...
            <div className='form-container'>
                <div className='form-inputs'>
                    <input type='text' name='first_name' placeholder='First name' value={newStudent.first_name}
                        onChange={handleInputChange} />
                    <input type='text' name='last_name' placeholder='Last name' value={newStudent.last_name}
                        onChange={handleInputChange} />
                    <input type='text' name='age' placeholder='Age' value={newStudent.age}
                        onChange={handleInputChange} />
                    <input type='text' name='gender' placeholder='Gender' value={newStudent.gender}
                        onChange={handleInputChange} />
                    <input type='text' name='grade' placeholder='Grade' value={newStudent.grade}
                        onChange={handleInputChange} />
                    <textarea name='address' placeholder='Address' value={newStudent.address}
                        onChange={handleInputChange} />
                    <input type='text' name='contact_number' placeholder='Contact Number' value={newStudent.contact_number}
                        onChange={handleInputChange} />
